...
public class IbBrokerWrapper implements EWrapper {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(IbBrokerWrapper.class);
    ...
    public IbBrokerWrapper(OrderService orderService) {
