package se.poket.microservices.composite.order;
...
import se.poket.microservices.composite.order.services.OrderCompositeIntegration;
...
public class OrderCompositeServiceApplication {
    ...
    @Autowired
    public OrderCompositeServiceApplication(@Value("${app.threadPoolSize:10}") Integer threadPoolSize, @Value("${app.taskQueueSize:100}") Integer taskQueueSize) {
